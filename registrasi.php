			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>jika sudah daftar, silahkan login gan...</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Registration</h3>
						<form class="row login_form" action="prosesregis.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="alamat" placeholder="Alamat" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat'">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="nohp" placeholder="No.Handphone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'No.Handphone'">
							</div>
							<div class="col-md-12 form-group">
